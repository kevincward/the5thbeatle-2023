        ...
        <main className='pt-20'>
                ...
                <div className='flex'>
                    <div className='lg:basis-1/2'>
                        ...
                        <p className='text-xl'>
                            ...
                            <a
                                className='font-recoleta text-purple font-medium'
            ...
            <div className='teams container py-16 lg:py-24'>
                ...
                <div className='mx-auto grid max-w-[42rem] grid-cols-4 gap-4 gap-x-0 lg:grid-cols-8'>
                    ...
                    <div className='w-100 text-center'>
                        <Image
                            src='/images/reflektive-icon.svg'
                            alt='Reflektive Icon'
                            height={56}
                            width={56}
                            className='inline-block'
                    ...
                    <div className='w-100 text-center'>
                        <Image
                            src='/images/nationbuilder-icon.svg'
                            alt='NationBuilder Icon'
                            height={56}
                            width={56}
                            className='inline-block'
                        />
                    ...
                    <div className='w-100 text-center'>
                        <Image
                            src='/images/thrive-global-icon.svg'
                            alt='Thrive Global Icon'
                            height={56}
                            width={56}
                            className='inline-block'
                        />
            ...
            <div className='skills mb-6 lg:py-12'>
                ...
                <div className='text-xl grid auto-cols-max grid-flow-col place-items-center overflow-x-auto pb-6 lg:place-content-center lg:overflow-x-auto lg:pb-12'>
