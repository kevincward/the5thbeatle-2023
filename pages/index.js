...
export default function Home() {
    ...
    return (
        <><div>
            <Head>
                <title>
                    Kevin Ward | Product Designer
                </title>
                <meta
                    name="description"
                    content="Review my product design journey across the universe. With a little help from my case studies, learn more about my product strategy and design thinking."
                    key="desc" />
            </Head>
        </div>
            <main className='pt-20'>
                ...
                <InView
                    as={motion.div}
                    initial='hidden'
                    animate={teamsVisible ? 'visible' : 'hidden'}
                    variants={{
