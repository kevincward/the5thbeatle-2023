...
export default function Trifecta() {
    ...
    const [DesignStrategyVisible, setDesignStrategyVisible] = useState(false);
    ...
    return (
        <>
            ...
            <InView
                as={motion.div}
                initial='hidden'
                animate={DesignStrategyVisible ? 'visible' : 'hidden'}
                variants={{
                    visible: { opacity: 1, y: 0, transition: { duration: 0.5 } },
                    hidden: { opacity: 0, y: 200, transition: { duration: 0.5 } },
                }}
            ...
            <InView
                as={motion.div}
                initial='hidden'
                animate={SystemVisible ? 'visible' : 'hidden'}
                variants={{
                    visible: { opacity: 1, y: 0, transition: { duration: 0.5 } },
                    hidden: { opacity: 0, y: 200, transition: { duration: 0.5 } },
                }}
